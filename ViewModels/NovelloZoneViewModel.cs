...
using DidUP_for_Windows_11.Contracts.ViewModels;

using Microsoft.Web.WebView2.Core;

namespace DidUP_for_Windows_11.ViewModels;
...
public partial class NovelloZoneViewModel : ObservableRecipient, INavigationAware
{
    // TODO: Set the default URL to display.
    [ObservableProperty]
    private Uri source = new("https://www.liceonovello.edu.it/");
    ...
    public NovelloZoneViewModel(IWebViewService webViewService)
    {
